 ...
 *
 */
class CRM_Report_Form_Contribute_QuotePart extends CRM_Report_Form {
    ...
    $this->_columns = array(
      ...
      array(
        ...
        array(
          ...
          'name' =>
          array(
            'title' => 'Adh&eacute;sion &agrave;',
          ),
        ),
        'filters' =>
        array(
          'id' =>
          array('title' => 'Adh&eacute;sion &agrave;',
            'operatorType' => CRM_Report_Form::OP_MULTISELECT,
        ...
        array(
          ...
          'trxn_date' => array(
            ...
            'type' => CRM_Utils_Type::T_DATE,
                  ...
                  'nstatus_id' => array(
                        'name' => 'status_id',
            'title' => ts('Status de la transaction '),
            'operatorType' => CRM_Report_Form::OP_MULTISELECT,
            'options' => CRM_Core_OptionGroup::values('financial_item_status'),
                        'default' => NULL,
            'type' => CRM_Utils_Type::T_STRING,
          ),
        ),
